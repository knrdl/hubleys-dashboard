...
<div class="border border-gray-200 dark:border-gray-700 px-6 py-3 max-w-xl bg-slate-100 dark:bg-gray-800 rounded-lg shadow-md z-10">
    ...
    {/if}
    {#if data.calendarEvents?.entries?.length > 0}
        <ol class="relative border-l border-gray-300 dark:border-gray-700">
            {#each data.calendarEvents?.entries as entry}
                ...
                <li class="ml-4 mb-3 first:pt-4 last:pb-4">
                    ...
                    <time class="mb-1 text-sm font-normal leading-none text-zinc-400 dark:text-zinc-400"
