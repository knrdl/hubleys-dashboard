...
<div
	class="bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 divide-x divide-dashed divide-slate-600 my-3 flex"
	transition:fade
>
			...
			{#if config.background === 'random'}
				...
				{:else if config.random_image.provider === 'reddit'}
					<label>
						...
						<input
							type="text"
							placeholder="e.g. wallpaper,wallpapers"
