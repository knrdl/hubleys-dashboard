...
const config: Config = {
  ...
  loaders: [
    { locale: 'en', key: 'calendar', loader: async () => (await import('./en/calendar.json')).default },
    ...
    { locale: 'de', key: 'calendar', loader: async () => (await import('./de/calendar.json')).default },
    ...
    { locale: 'es', key: 'calendar', loader: async () => (await import('./es/calendar.json')).default },
